...
<div id="portfolio-box-item">
	<h2 class="boxtoptitle" ><?php echo esc_html(innovation_get_option('portfolioboxes-heading', 'A FEW FROM OUR PORTFOLIO')); ?></h2>
    ...
    <ul class="grid-portfolio slides  cs-style-3">
				...
				<li>
					<figure>
                        ...
                        <figcaption>
							<h3><?php echo esc_html(innovation_get_option('portfolioboxes-title' . $portfolioboxsnumber, 'OUR PROJECT '. $portfolioboxsnumber )); ?></h3>
...
<div id="heading-box-item" class="heading1container">
	<div class="heading1vcenter">
		<h1 id="heading1" ><?php echo wp_kses_post(innovation_get_option('heading_text1', 'WordPress is web <em>software you can use to create websites!</em> ')); ?></h1>
		<p class="heading-desc1"><?php echo wp_kses_post(innovation_get_option('heading_des1', 'It is Amazing! <em>Over 60 million people</em> have chosen WordPress to power the place on the web.')); ?></p>
...
<div id="staff-box-item">
	<h2 class="boxtoptitle" ><?php echo esc_html(innovation_get_option('staffboxes-heading', 'WE ARE INSIDE')); ?></h2>
	<h4 class="boxtopdes" ><?php echo esc_textarea(innovation_get_option('staffboxes-heading-des', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua')); ?></h4>
			...
			<div id="grid-staff" class="main">
				...
				<div class="view-staff" >
                    ...
                    <h3><?php echo esc_html(innovation_get_option('staffboxes-title' . $staffboxsnumber, 'OUR PROUD STAFF '. $staffboxsnumber )); ?></h3>
                    <p><?php echo esc_html(innovation_get_option('staffboxes-description' . $staffboxsnumber, 'Service Executive' )); ?></p>
                    </div>
