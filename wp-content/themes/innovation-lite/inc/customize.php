...
//  Responsive Layout
	...
	// Contact Number
    $wp_customize->add_setting('innovation[contactnumber]', array(
        'default'        	=> __('012-345-6789','innovation-lite'),
        'capability'     	=> 'edit_theme_options',
    ...
    $wp_customize->add_control('innovation_contactnumber', array(
        'label'      => __('Contact Number', 'innovation-lite'),
        'section'    => 'innovation_options',
        'settings'   => 'innovation[contactnumber]'
    ));
	
	// Contact E-Mail
    $wp_customize->add_setting('innovation[extra-num]', array(
    ...
    $wp_customize->add_control('innovation_extra-num', array(
        'label'      => __('Contact E-Mail', 'innovation-lite'),
        'section'    => 'innovation_options',
        'settings'   => 'innovation[extra-num]'
    ));
