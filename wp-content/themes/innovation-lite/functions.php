...
// 	Post Meta design
	...
	<div class="post-meta"> <span class="post-edit"> <?php edit_post_link(__('Edit', 'innovation-lite'),'<span class="fa-edit">','</span>' ); ?></span> <span class="post-author fa-user-md"> <?php the_author_posts_link(); ?> </span> <span class="post-date fa-clock"><?php the_time('F j, Y'); ?></span>	<span class="post-tag fa-tags"> <?php the_tags('' , ', '); ?> </span> <span class="post-category fa-archive"> <?php the_category(', '); ?> </span> <span class="post-comments fa-comments"><?php comments_popup_link(__('No Comments', 'innovation-lite') . ' &#187;', __('One Comment', 'innovation-lite') . ' &#187;', '% ' . __('Comments', 'innovation-lite') . ' &#187;'); ?> </span>
	</div> 
