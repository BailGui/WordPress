...
class Init {
	...
	public function template_path( $template_file, $theme_slug, $template_slug ) {
		...
		switch ( $template_slug ) {
			...
			case 'pricing':
				return $directory . '/gutenverse-files/templates/pricing.html';
			case 'project-details':
				return $directory . '/gutenverse-files/templates/project-details.html';
			case 'projects':
			...
			case 'team':
				return $directory . '/gutenverse-files/templates/team.html';
			case 'header':
