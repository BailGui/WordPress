...
<div class="wp-block-group" style="padding-right:0;padding-left:0">
	...
	<div class="wp-block-group">
		...
		<!-- wp:search {"label":"<?php echo esc_attr_x( 'Search', 'search form label', 'ronny' ); ?>","showLabel":false,"placeholder":"<?php echo esc_attr_x( 'Search...', 'search form placeholder', 'ronny' ); ?>","width":100,"widthUnit":"%","buttonText":"<?php echo esc_attr_x( 'Search', 'search form label', 'ronny' ); ?>"} /-->
	</div>
	<!-- /wp:group -->
