    ...
    <div class="wp-block-cover__inner-container">
        ...
        <div class="wp-block-group alignwide" style="min-height:600px">
            ...
            <div class="wp-block-columns alignwide has-background" style="background:linear-gradient(0deg,rgb(255,255,255) 50%,rgba(255,255,255,0) 50%);margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
                ...
                <!-- wp:column {"width":"800px","style":{"spacing":{"padding":{"top":"var:preset|spacing|40","right":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"var:preset|spacing|40"}}},"backgroundColor":"white","textColor":"black"} -->
                <div class="wp-block-column has-black-color has-white-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40);flex-basis:800px">
                    <!-- wp:heading {"level":2} -->
...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column"><!-- wp:paragraph {"fontSize":"big"} -->
            ...
            <!-- wp:paragraph -->
            <p>Ronny values customer support satisfaction. No question has been left unanswered. We resolve everything!</p>
            <!-- /wp:paragraph -->
