...
<div class="wp-block-group alignwide" style="padding-top:20px;padding-bottom:20px">
    ...
    <div class="wp-block-group alignwide">
        ...
        <!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|x-small"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"right"}} -->
        <div class="wp-block-group">
            ...
            <!-- wp:pattern {"slug":"ronny/hidden-header-woocommerce"} /-->
            <!-- wp:search {"label":"Search","showLabel":false,"buttonText":"Search","buttonPosition":"button-only","buttonUseIcon":true,"isSearchFieldHidden":true,"className":"header-modal"} /-->
        </div>
        <!-- /wp:group -->
